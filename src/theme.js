...
function getTheme({ style, name }) {
  ...
  return {
    ...
    colors: {
      ...
      focusBorder: primer.yellow[9] + '59',
      ...
      "dropdown.background": primer.nushuGray[0],
      ...
      "badge.foreground": primer.blue[4],
      // "badge.background": primer.blue[1],
      "badge.background": primer.white,
      ...
      "sideBar.background": primer.nushuGray[1],
      ...
      "sideBarSectionHeader.background": primer.nushuGray[1],
      ...
      "list.hoverBackground": auto("#ebf0f4") + 'E6',
      // "list.inactiveSelectionBackground": auto("#e8eaed"),
      "list.inactiveSelectionBackground": primer.nushuGray[2] + 'F2',
      // "list.activeSelectionBackground": auto("#e2e5e9"),
      "list.activeSelectionBackground": auto("#e2e5e9") + 'F2',
      "list.focusBackground": primer.blue[1] + 'F2',
      ...
      "editorGroupHeader.tabsBackground": primer.nushuGray[1],
      ...
      "tab.inactiveBackground": primer.nushuGray[1],
      ...
      "editor.inactiveSelectionBackground": primer.yellow[7] + '11',
      "editor.selectionBackground": primer.yellow[7] + '25',
      "editor.wordHighlightBackground": primer.yellow[7] + '22',
      ...
      "panel.background": primer.nushuGray[1],
